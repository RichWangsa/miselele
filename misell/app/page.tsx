  ...
  const steps = [
    ...
    <motion.div key="step0" className="text-center" {...fadeInUp}>
      <h1 className="text-4xl font-bold mb-6 text-pink-600">
        Michelle Lee Would you go on a date with me?
      </h1>
      <motion.img
    ...
    <motion.div key="step2" className="text-center" {...fadeInUp}>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        {[
          { name: "Rice with etc", icon: <Utensils /> },
          { name: "Tahu Balek", icon: <Utensils /> },
          { name: "ciak ayam nyam", icon: <Utensils /> },
          { name: "Noodles With etc", icon: <Coffee /> },
    ...
    <motion.div key="step5" className="text-center" {...fadeInUp}>
      ...
      >
        ...
        <p>Then we&apos;ll go &quot;{answers.movie}&quot; together.</p>
